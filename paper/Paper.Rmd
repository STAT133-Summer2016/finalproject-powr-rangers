...
```{r, echo = FALSE, fig.cap="Median Income Adjusted for the Number of People by Region"}
clean_years %>%
...
```{r, echo = F, fig.cap="Median Income Adjusted for Number of Bedrooms by region"}
clean_years %>%
  group_by(year, region) %>%  
  # Take the median instead of mean to avoid extreme observations skewing the 
  # result.

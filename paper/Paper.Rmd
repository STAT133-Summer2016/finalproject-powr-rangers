...
```{r, echo = FALSE, fig.cap="Median Income Adjusted for the Number of People by Region", fig.width=3.5, fig.height=4}
clean_years %>%
  ...
  ggplot(aes(x = year,   
                  ...
                  colour = region)) + 
  geom_line(size = 1) + 
  labs(x = "Year", title = "Median Adjusted Income (per persons)") + 
  scale_y_continuous(labels=function(x){paste0(x/1000, "K ")}) +
  scale_colour_brewer(palette = "Dark2", 
                      name = "Region", 
                      labels = regionNames) +
  theme_minimal(base_family = "serif") +
  theme(legend.position = "none", axis.title.y = element.blank())
...
clean_years %>%
  ...
  ggplot(aes(x = year,   
                  ...
                  colour = region)) + 
  geom_line(size = 1) +
  labs(x = "Year", title = "Median Adjusted Income (per bedroom)") +
  scale_y_continuous(labels=function(x){paste0(x/1000, "K ")}) +
  scale_colour_brewer(palette = "Dark2",
                      name = "Region", 
                      labels = regionNames) +

...
```{r, echo = FALSE, fig.cap="Relationship between Household Income and Burden, fig.height = 1"}
###### Household Income
  ####overall graph
clean_years %>% 
  select(zinc2, 
...
At a certain point, regardless of income, housing costs stay the same because housing prices have increased  

The no income line continues to have monthly housing costs due to people who lost their jobs, unemployment, trust fund recipients using their money, and people living off savings

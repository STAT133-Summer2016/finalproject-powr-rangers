...
From the collected, exploratory data, it is seen that the overall conclusion drawn is that housing affordability has decreased over the years. From the data, it is seen that there were many dips and peaks coincidentally near the years of 2007 and forward, which is indicative of the financial housing bubble crisis that occurred in 2007. 

In several of the graphs, the dips occur near 2007, 2008, and we conclude these as being consequences of the crash of 2007. One of the greatest factors is burden, which has increased over the years. If we compare

Because our data only extends towards 2013, we don't have more recent data to make any great assumptions on the future of the housing market. According to an "ARTICLE HERE", the United States housing sector might be headed towards another bubble. 
